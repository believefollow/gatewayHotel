...
@RestController
@RequestMapping("/api/gateway-hotel-kafka")
public class GatewayHotelKafkaResource {
    private final Logger log = LoggerFactory.getLogger(GatewayHotelKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GatewayHotelKafkaResource(KafkaProperties kafkaProperties) {
